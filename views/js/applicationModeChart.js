        ...
        options: {
            scales: {
                ...
                y: {
                    ...
                    max: Math.max(...dzongkhagCounts) + 1, // Set max y-axis value slightly above max count
                    title: {
                        display: true,
            ...
            options: {
                scales: {
                    y: {
                        beginAtZero: true,
                        min: 0, // Set minimum y-axis value
                        max: Math.max(...statusCounts) + 1, // Set max y-axis value slightly above max count
                        ticks: {
                            stepSize: 1 // Ensure y-axis increments by 1
                        }
                    }
          ...
          options: {
              scales: {
                  y: {
                      ...
                      min: 0, // Set minimum y-axis value
                      max: Math.max(...occupationCounts) + 1, // Set max y-axis value slightly above max count
                      ticks: {
                          stepSize: 1 // Ensure y-axis increments by 1
                      }
                  }
